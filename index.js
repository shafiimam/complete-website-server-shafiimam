...
client.connect(err => {
    const orderCollection = client.db("freelancerBD").collection("orders");
    const reviewCollection = client.db("freelancerBD").collection("reviews");
    const servicesCollection = client.db("freelancerBD").collection("services");
    const adminCollection = client.db("freelancerBD").collection("adminEmail");
